...
interface MenuScreenProfileProps {
  menu: Menu;
  onBack: () => void;
...
export function MenuScreenProfile({ menu, onBack, onDishClick, onReviewClick, onSearchClick }: MenuScreenProfileProps) {
  return (
    <>
      {/* Header */}
